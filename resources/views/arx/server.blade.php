...
@section('title', 'ARX SERVER | ARX SERVER')

@section('meta_description', 'ARX SERVER')
        ...
        <div class="max-w-5xl mx-auto px-4 py-12">
            ...
            <div class="arx-ai-box">
                ...
                <div class="arx-ai-visual text-center">
                    ...
                    <img src="{{ asset('assets/img/arx_server/arx_server.svg') }}" alt="ARX AI" class="arx-ai-image mx-auto">
